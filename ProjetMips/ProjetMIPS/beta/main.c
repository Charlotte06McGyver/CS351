...
int main(){
  ...
  lecture_operateur("ADDI $5, $0, 2($5)", operateur);
  printf("Opérateur : %s\n", operateur);
  int operande[4] = {-1,-1,-1, -1};                       //Attention pour la suite si y a besoin de moins de 3 opérandes
  lecture_operandeI("ADDI $5, $0, 2($5)", operande);
