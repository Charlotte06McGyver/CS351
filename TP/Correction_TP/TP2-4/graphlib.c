...
/*************************************************************************/
/* gr_inits_w(larg,haut,titre) : initialisation de l'écran graphique 
  crée une fenêtre par defaut X-Window de taille larg X haut avec un titre */
...
void gr_inits_w(int larg, int haut, char titre[])
{
  ...
  /* Solicitation des évènements en entrée. Indispensable */
...
/*bouton fournit le numero de bouton si un bouton de la souris a été
  enfoncé, 0 sinon */
